export const state = { keys: [], logs: [], audit: [], observability: null, config: null, trace: null, keyFailures: {}, selectedId: null, timer: null, events: null, eventRefreshPending: false, keyPage: 1, keyPageSize: 50, pageKeyIds: [], problemKeyIds: [], lastOperation: null, detailFocusAction: null, detailFocusUntil: 0, secretDisplay: localStorage.getItem('exaSecretDisplay') || 'plain', activeTab: 'keys', keyFilter: 'All', keySort: { column: null, direction: 'asc' }, selectedKeyIds: [], mobileDetailsOpen: false };
